...
namespace SeleniumFramework.BusinessFunctions
{
    public class CommonFeatures : UIActions
    {
        ...
        public void Environment01()
        {
            ...
            GlobalVariables.Scheme = xmlReader.ReadTagValue("QA_Scheme1");
            GlobalVariables.AuthKey = xmlReader.ReadTagValue("QA_AuthKey1");
            GlobalVariables.SessionId = xmlReader.ReadTagValue("QA_SessionId1");

            GlobalVariables.Scheme1 = xmlReader.ReadTagValue("QA_Scheme2");
            GlobalVariables.AuthKey1 = xmlReader.ReadTagValue("QA_AuthKey2");
        }
        ...
        public void Environment02()
        {
            ...
            GlobalVariables.Scheme = xmlReader.ReadTagValue("QAE_Scheme1");
            GlobalVariables.AuthKey = xmlReader.ReadTagValue("QAE_AuthKey1");
            GlobalVariables.SessionId = xmlReader.ReadTagValue("QAE_SessionId1");

            GlobalVariables.Scheme1 = xmlReader.ReadTagValue("QAE_Scheme2");
            GlobalVariables.AuthKey1 = xmlReader.ReadTagValue("QAE_AuthKey2");
        }
        ...
        public string GetVariableName()
        {
            ...
            TypeInfo t = typeof(GlobalVariables).GetTypeInfo();
